<template>
    ...
    <div>
        ...
        <div v-if="elemDetails.data.type == 'carousel'">
            ...
            <div class="row align-items-center">
                <label class="col-md-3 fw-bold text-uppercase">CONTENT AREA BASE</label>
                <div class="col-md-9">
                    <InputSwitch v-model="elemDetails.data.contentSizeBase" />
                </div>
            </div>
        </div>
...
let cardTypes = ['default','blog','custom'];
...
const prepareElement = async () => {
    ...
    let promise = new Promise(function(resolve, reject) {
        ...
        if( elemDetails.value.data.type == 'carousel' ) {
            ...
            if( elemDetails.value.data.stagepadding ){
                ...
                swiperOptionsData.slidesOffsetAfter = 15;
            ...
            if( elemDetails.value.data.loop ){
                swiperOptionsData.rewind = true; //loop yerine rewind daha iyi
            }
            ...
            swiperOptionsData.slidesPerView = 1 + stagePadding.default;
        ...
        elemDetails.value.data.prevHtml = 'Kampanya Listesi Widget';
