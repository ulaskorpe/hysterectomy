<template>
    ...
    <div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-9">
                <Dropdown v-model="elemDetails.data.titleStyle" showClear :options="['title-style-one','title-style-two','title-style-three','title-style-four','title-style-five','title-style-six','title-style-seven']" class="w-100" />
            </div>
        </div>
