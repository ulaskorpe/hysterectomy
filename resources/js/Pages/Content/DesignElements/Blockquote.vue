...
const prepareElement = async () => {
    ...
    let promise = new Promise(function(resolve, reject) {
        ...
        const elemDiv = document.createElement("blockquote");
        ...
        iconElem.classList.add("bi","bi-quote");
        ...
        textDiv.innerText = elemDetails.value.data.text;
        elemDiv.appendChild(textDiv);
        elemDiv.appendChild(iconElem);
