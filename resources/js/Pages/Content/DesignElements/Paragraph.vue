<template>
    ...
    <div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-9">
                <Textarea autoResize rows="1" cols="30" class="w-100" v-model="elemDetails.data.text" />
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <label class="col-md-3 fw-bold text-uppercase">LEAD</label>
            <div class="col-md-9">
                <InputSwitch v-model="elemDetails.data.lead" />
            </div>
        </div>
...
import {textColors} from "./design-elements-data.js";
...
const prepareElement = async () => {
    ...
    let promise = new Promise(function(resolve, reject) {
        ...
        const elemDiv = document.createElement("p");

        elemDiv.classList.add(elemDetails.value.data.baseDesignOptions.position);
        
        if(elemDetails.value.data.lead){
            elemDiv.classList.add("lead");
        }
        ...
        elemDiv.innerText = elemDetails.value.data.text;
