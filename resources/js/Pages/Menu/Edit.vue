<template>
    <Head head-key="title" title="Menü Güncelle" />
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div  class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    Menü Güncelle: {{ props.menu.name }}
                </h1>
            </div>

            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link :href="route('menus.index',{language:props.menu.language})" class="btn fw-bold btn-sm btn-secondary d-flex align-items-center">
                            ...
                            <div class="col-md-3">
                                <div class="d-flex align-items-center mb-1">
                                    ...
                                    <div class="d-flex align-items-center ms-2">
                                        <img :src="`/dmn/media/flags/${props.menu.language}.svg`" class="me-2" style="width: 14px" />
                                        <span class="text-uppercase">{{ props.menu.language }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
...
const update = () => {
    form.put(route('menus.update',[props.menu,{language:props.menu.language}]),{
        only:['menu','flash','errors'],
        onSuccess: () => {
...
const getLinkableContents = () => {
    ...
    fetch(route('menus.contents',{language:props.menu.language})).then(function (response) {
