<template>
    ...
    <div>
        ...
        <Dialog v-model:visible="dialogVisible" modal header="Yeni Ürün Müşteri Seçeneği" :style="{ width: '50vw' }" :breakpoints="{ '960px': '75vw', '641px': '95vw' }">
            <form @submit.prevent="create">
                ...
                <div class="d-flex flex-column">
                    ...
                    <Textarea autoResize rows="1" cols="30" class="w-100" v-model="form.desc" />
                </div>
...
const form = useForm({
    ...
    desc:props.fromAttribute ? props.fromAttribute.desc : "",
});
...
const create = () => {
    form.post(route('product-customer-attributes.store'),{
        onSuccess: () => {
            form.reset();
