...
const form = useForm({
    sku:Math.random().toString().substr(2, 6),
    language:curr_language,
    name:props.copy_content ? props.copy_content.name : "",
    ...
    additional:{
        ...
        options_for_use:props.product_type.option_group ? (props.copy_content && props.copy_content.additional && props.copy_content.additional.options_for_use ? props.copy_content.additional.options_for_use : props.product_type.option_group.options.map(o => o.id)) : []
    },
    ...
    price:props.copy_content && props.copy_content.price ? props.copy_content.price.price : null,
    has_discount:props.copy_content ? props.copy_content.has_discount : false,
    discount_type:props.copy_content && props.copy_content.price && props.copy_content.price.discount ? props.copy_content.price.discount.discount_type : "percentage",
    discount_value:props.copy_content && props.copy_content.price && props.copy_content.price.discount ? props.copy_content.price.discount.value : 0,
    stock:props.copy_content ? props.copy_content.stock : null,
    ...
    after_order_download_name:props.copy_content ? props.copy_content.after_order_download_name : null,
    after_order_download_file:props.copy_content ? props.copy_content.after_order_download_file : null,
    after_order_email_subject:props.copy_content ? props.copy_content.after_order_email_subject : null,
    after_order_email_body:props.copy_content ? props.copy_content.after_order_email_body : null,
    seo:{
    ...
    use_option_group:props.option_group ? true : false,
    use_variables:props.copy_content ? props.copy_content.use_variables : false,
    is_published:false,
    featured:props.copy_content ? props.copy_content.featured : false,
    content:props.copy_content ? props.copy_content.content : [],
    tax_id:props.product_type.tax_id,
...
const create = () => {
    form.post(route('products.store', {productType:props.product_type.id}),{
        onSuccess: () => {
