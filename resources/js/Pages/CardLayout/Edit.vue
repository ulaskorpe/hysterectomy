    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <form @submit.prevent="update">
                ...
                <ContentArea :form="form" :use-sections="false" :use-containers="false" :layout-mode="true" :product-layout-mode="true" :add-section="props.layout.content && props.layout.content.length > 0 ? false : true"/>
