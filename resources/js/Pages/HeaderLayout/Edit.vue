    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <form @submit.prevent="update">
                ...
                <ContentArea :form="form" :use-sections="false" :layout-mode="true" :add-section="props.layout.content && props.layout.content.length > 0 ? false : true"/>
...
const form = useForm({
    ...
    json_data:{
        logo:{
            main:props.layout.json_data ? props.layout.json_data.logo.main : null,
            mobile:props.layout.json_data ? props.layout.json_data.logo.mobile : null,
        },
        backgroundClass:props.layout.json_data ? props.layout.json_data.backgroundClass : "",
        linkColorClass:props.layout.json_data ? props.layout.json_data.linkColorClass : "",
        headerButtonOneClass:props.layout.json_data ? props.layout.json_data.headerButtonOneClass : "",
        headerButtonTwoClass:props.layout.json_data ? props.layout.json_data.headerButtonTwoClass : "",
    },
    content:props.layout.content ?? [],
});

const update = () => {
    form.put(route('header-layouts.update',props.layout),{
        onSuccess: () => {
