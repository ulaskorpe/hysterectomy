<template>
    <Head head-key="title" title="Sidebar Ekle" />
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <form @submit.prevent="create">
                ...
                <ContentArea :form="form" :use-sections="false" :use-containers="false" :use-rows="false" :layout-mode="true"/>
...
const create = () => {
    form.post(route('sidebars.store'),{
        onSuccess: () => {
