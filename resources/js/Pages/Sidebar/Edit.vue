<template>
    <Head head-key="title" :title="props.sidebar.name" />
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div  class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    Güncelle: {{ props.sidebar.name }}
                </h1>
            </div>

            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link :href="route('sidebars.index')" class="btn fw-bold btn-sm btn-secondary d-flex align-items-center">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <form @submit.prevent="update">
                ...
                <ContentArea :form="form" :use-sections="false" :use-containers="false" :use-rows="false" :layout-mode="true" :add-section="props.sidebar.content && props.sidebar.content.length > 0 ? false : true"/>
...
const update = () => {
    form.put(route('sidebars.update',props.sidebar),{
        onSuccess: () => {
