<template>
    <Head head-key="title" title="Medya Kütüphanesi" />
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header px-4" v-if="selectedItems.length > 0">
                    ...
                    <div class="card-toolbar">
                        <DeleteBulkPrompt :uri="route('medias.bulk.delete')" :items="selectedItems" :message="'Seçilen kayıtlar tamamen silinecek. Bu işlem geri alınamaz!'"/>
                    </div>
                </div>
                <div class="card-body p-0">

                    <DataTable v-model:selection="selectedItems" :value="props.medias.data" scrollable scrollHeight="flex" dataKey="id" tableStyle="min-width: 50rem">
                        ...
                        <Column class="text-end">
                            <template #body="{ data }">
                                <div class="d-flex flex-nowrap justify-content-end">
                                    ...
                                    <DeletePrompt :delete-done="resetSelectedItems" :uri="route('medias.destroy',data.id)" :model="data" :message="'Medya tamamen silinecek. Bu işlem geri alınamaz!'"/>
                                </div>
                            </template>
                        </Column>
                    </DataTable>
                ...
                <div class="card-footer">
                    <Pagination :links="props.medias.links" />
                </div>
            </div>
...
watch(() => ([params.search]), debounce(function (){
    ...
    router.get(route('medias.index'),routeParams,
        {
            preserveState: true,
            replace:true,
        }
