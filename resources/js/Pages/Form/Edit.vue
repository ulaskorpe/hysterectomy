...
let inputTypes = ['text','number','email','textarea','password','select','multiselect','radio','checkbox','intTelInput','countrySelect','stateSelect','citySelect','range',
    'radioWithIcon',
    'checkboxWithIcon','contentList','contentListCheckBox','noninput_text'];
