<template>
    <Head head-key="title" :title="props.template.name" />
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <form @submit.prevent="update">
                ...
                <ContentArea :form="form" :use-sections="false" :add-section="false" :use-columns="form.use_columns" :use-rows="form.use_rows" :use-containers="form.use_containers"/>
...
const form = useForm({
    ...
    use_columns:props.template.use_columns ?? false,
    use_rows:props.template.use_rows ?? false,
    use_containers:props.template.use_containers ?? false
});

const update = () => {
    form.put(route('design-templates.update',props.template),{
        onSuccess: () => {
