...
<div>
    ...
    <button type="button" @click="confirmDialog($event)" class="btn btn-icon btn-sm btn-light-warning"><i class="bi bi-pause fs-3"></i></button>
</div>
</template>
<script setup>
...
const props = defineProps({
    ...
    message:{
        type:String,
        default:'Seçtiğiniz kayıt yayına alınacak.'
    },
    deleteDone:{
        type:Function,
        required:false,
