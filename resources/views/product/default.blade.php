<x-fe-layout>
    ...
    <div class="content-section bg-theme position-relative">
        <div @class(['shape-waves-opacity','white','mb-n1'])>
    ...
    @if ($content->product_type->is_cartable)
    <x-product-layout.product-details-cartable :product="$content" />
    @else
    <x-product-layout.product-details-noncartable :product="$content" />
    @endif
