                    ...
                    <div class="u-row-container" style="padding: 25px 0px 0px;background-color: transparent">
                        <div class="u-row"
                            ...
                            <div
                                ...
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 25px 0px 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:500px;"><tr style="background-color: #ffffff;"><![endif]-->
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                ...
                                                                <ul style="padding-left:0;">
                                                                    ...
                                                                    @foreach ($entry['json_data'] as $key => $value)
                                                                    @if ($value['label'])
                                                                    ...
                                                                    @else
                                                                    <li style="padding-top:4px; padding-bottom:4px"><strong>{{$value['label']}}</strong>: {{$value['value']}}</li>
                                                                    @endif
